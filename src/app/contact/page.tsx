            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white p-10 rounded-xl shadow-lg">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="mt-10 rounded-lg overflow-hidden shadow-md">
                    <img
                        src="https://placehold.co/600x300/F0F8FF/000000?text=Map+Location"
                        alt="Map of our office location"
                        className="w-full h-auto object-cover"
                        onError={(e) => { (e.target as HTMLImageElement).onerror = null; (e.target as HTMLImageElement).src="https://placehold.co/600x300/F0F8FF/000000?text=Map+Placeholder" }}
                    />
                </div>
              </div>
